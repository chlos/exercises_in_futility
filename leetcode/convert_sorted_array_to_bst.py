...
class Solution(object):
    ...
    #     :rtype: TreeNode
    #     """
    #     def makeBST(nums, left_node, right_node):
    #         pass
    #
    #     root_node = TreeNode(nums[0])
    #     left_value = min(nums[1], nums[2])
    #     right_value = max(nums[1], nums[2])
    #     root_node.left = TreeNode(left_value)
    #     root_node.right = TreeNode(right_value)
    #
    #     makeBST(nums[3:], root_node.left, root_node.right)
    #     return root_node
